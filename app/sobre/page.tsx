    ...
    <div className="page-container bg-white dark:bg-gray-950 transition-colors duration-300">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        <Card className="border-0 bg-transparent shadow-none mb-12">
          <CardContent className="p-0">
            <div className="backdrop-blur-xl bg-white/10 dark:bg-gray-900/10 border border-white/20 dark:border-gray-700/30 rounded-3xl p-8 shadow-2xl shadow-black/10 dark:shadow-black/30">
              <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-8">Sobre a Loyfus</h1>
          ...
          <Card className="border-0 bg-transparent shadow-none">
            <CardContent className="p-0">
              <div className="backdrop-blur-xl bg-white/10 dark:bg-gray-900/10 border border-white/20 dark:border-gray-700/30 rounded-2xl p-6 shadow-xl shadow-black/5 dark:shadow-black/20 text-center">
                ...
                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Busca Inteligente</h2>
          ...
          <Card className="border-0 bg-transparent shadow-none">
            <CardContent className="p-0">
              <div className="backdrop-blur-xl bg-white/10 dark:bg-gray-900/10 border border-white/20 dark:border-gray-700/30 rounded-2xl p-6 shadow-xl shadow-black/5 dark:shadow-black/20 text-center">
                ...
                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Categorização Precisa</h2>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
          ...
          <Card className="border-0 bg-transparent shadow-none">
            <CardContent className="p-0">
              <div className="backdrop-blur-xl bg-white/10 dark:bg-gray-900/10 border border-white/20 dark:border-gray-700/30 rounded-2xl p-6 shadow-xl shadow-black/5 dark:shadow-black/20 text-center">
                ...
                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Comunidade Ativa</h2>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Avaliações e feedback da comunidade para decisões informadas
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="border-0 bg-transparent shadow-none">
          <CardContent className="p-0">
            <div className="backdrop-blur-xl bg-white/10 dark:bg-gray-900/10 border border-white/20 dark:border-gray-700/30 rounded-3xl p-8 shadow-2xl shadow-black/10 dark:shadow-black/30">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Nossa Missão</h2>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                <p className="text-sm text-gray-500 dark:text-gray-400">Fundada em 2025 • Baseada no Brasil</p>
              </div>
            </div>
          </CardContent>
        </Card>
