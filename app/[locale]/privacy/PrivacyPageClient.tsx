          ...
          <CardContent className="p-0">
            <div className="backdrop-blur-xl bg-gray-900/10 border border-gray-700/30 rounded-3xl p-8 shadow-2xl shadow-black/30">
              ...
              <div className="prose prose-gray prose-invert max-w-none space-y-6">
                ...
                <h2 className="text-2xl font-bold text-gray-100 mt-8 mb-4">{t("infoWeCollect")}</h2>
                <p className="text-gray-300 leading-relaxed">{t("infoDesc")}</p>
                <ul className="list-disc list-inside text-gray-300 space-y-2">
                  <li>{t("personalData")}</li>
                  <li>{t("usageData")}</li>
                </ul>

                <h2 className="text-2xl font-bold text-gray-100 mt-8 mb-4">{t("howWeUse")}</h2>
                <p className="text-gray-300 leading-relaxed">{t("howWeUseDesc")}</p>
                <ul className="list-disc list-inside text-gray-300 space-y-2">
                  <li>{t("provide")}</li>
                  <li>{t("improve")}</li>
                  <li>{t("understand")}</li>
                ...
                <h2 className="text-2xl font-bold text-gray-100 mt-8 mb-4">{t("yourRights")}</h2>
                <p className="text-gray-300 leading-relaxed">{t("rightsDesc")}</p>

                <p className="text-gray-300 leading-relaxed">{t("updates")}</p>
              </div>
            </div>
          </CardContent>
        </Card>
