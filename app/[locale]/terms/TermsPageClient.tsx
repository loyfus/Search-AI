          ...
          <CardContent className="p-0">
            <div className="backdrop-blur-xl bg-gray-900/10 border border-gray-700/30 rounded-3xl p-8 shadow-2xl shadow-black/30">
              ...
              <div className="prose prose-gray prose-invert max-w-none space-y-6">
                ...
                <h2 className="text-2xl font-bold text-gray-100 mt-8 mb-4">{t("acceptance")}</h2>
                <p className="text-gray-300 leading-relaxed">{t("acceptanceDesc")}</p>

                <h2 className="text-2xl font-bold text-gray-100 mt-8 mb-4">{t("changes")}</h2>
                <p className="text-gray-300 leading-relaxed">{t("changesDesc")}</p>

                <h2 className="text-2xl font-bold text-gray-100 mt-8 mb-4">{t("conduct")}</h2>
                <p className="text-gray-300 leading-relaxed">{t("conductDesc")}</p>

                <h2 className="text-2xl font-bold text-gray-100 mt-8 mb-4">{t("intellectual")}</h2>
                <p className="text-gray-300 leading-relaxed">{t("intellectualDesc")}</p>

                <h2 className="text-2xl font-bold text-gray-100 mt-8 mb-4">{t("disclaimer")}</h2>
                <p className="text-gray-300 leading-relaxed">{t("disclaimerDesc")}</p>

                <p className="text-gray-300 leading-relaxed">{t("conclusion")}</p>
              </div>
            </div>
          </CardContent>
        </Card>
